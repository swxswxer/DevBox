...
import LeShuaPayCallbackVerify from "./components/LeShuaPayCallbackVerify.vue";
...
const navItems = [
  ...
  { id: 'leshua-pay-callback-verify', name: '乐刷支付回调验签', component: LeShuaPayCallbackVerify },
