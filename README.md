...
体积小、启动快、低内存占用，一站式开箱即用，专注提升开发与工作效率。
...
2.windows打开应用提示：智能应用控制已阻止可能不安全的应用

此提示是因为 Windows 的“**智能应用控制**”（Smart App Control）认为该未签名或来源不明的应用程序存在潜在风险而将其拦截。您可以按照以下步骤将其解除：

1. **按下快捷键 ****Win + I** 打开系统设置。
2. **在左侧栏点击进入 ****隐私和安全性****。**
3. **找到并点击 ****Windows 安全中心****。**
4. **点击 ****应用和浏览器控制****。**
5. **点击 ****智能应用控制设置****，然后将该功能设置为 ****关闭**
